...
public class NNSolutionTwo {
	...
	public static void main(String[] args) throws IOException {
		...
		int trainingNum = iohandler.getTrainingSetNumber(br);

		// Reading the inputs : training examples
		ArrayList<ArrayList<Double>> allInputs = iohandler.getInputs(br, trainingNum);
		...
		ArrayList<ArrayList<Double>> allOutputs = handler.getAllOutputs();
